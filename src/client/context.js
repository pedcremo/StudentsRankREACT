...
events.subscribe('context/loginCode',(obj)=>{
  loadTemplate('api/read/'+obj,function(userData) {
    ...
    reactDOM.render(<RankingListPage displayName={''} defaultTerm={Settings.getDefaultTerm()} gtWeight={Settings.getGtWeight()} xpWeight={Settings.getXpWeight()} students={Person.getStudentsFromMap()} readOnly={true} selectedIds={context.selectedIds}/>, document.getElementById('content'));
  },'GET','',false);  
});
